...
in
{
  ...
  config = {
    ...
    systemd.services.tufted = {
      wantedBy = [ "multi-user.target" ];
      serviceConfig = {
        ExecStart = "${pkgs.tufted}/bin/tufted /home/nixwrehost/nixwrehost";
      };
    };
    ...
    virtualisation = {
      ...
      sharedDirectories = {
        nixwrehost = {
          ...
          target = "/home/nixwrehost/nixwrehost";
        };
      };
    };
    ...
    users.users.nixwrehost = {
      isNormalUser = true;
      uid = 1000;
      extraGroups = [ "wheel" ];
      openssh.authorizedKeys.keys = cfg.keys;
    };
    services.getty.autologinUser = "nixwrehost";
  };
}
